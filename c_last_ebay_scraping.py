...
# Create a directory for eBay folder in C drive
ebay_base_folder = "C:\\eBay"
if not os.path.exists(ebay_base_folder):
    os.makedirs(ebay_base_folder)

# Create a directory for yesterday's date inside the eBay folder
date_folder = os.path.join(ebay_base_folder, yesterday.strftime("%Y-%m-%d"))
