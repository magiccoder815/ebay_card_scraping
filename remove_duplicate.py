...
# List of folders
folders = ["Auto Racing", "Football", "Basketball", "Baseball", "Boxing", "Ice Hockey"]

# Iterate through each folder
for folder in folders:
    # Construct the file path for the Excel file in the current folder
    file_path = os.path.join(folder, f"{folder}_Sold_Data.xlsx")  # Adjust the file name as needed
    ...
    if os.path.exists(file_path):
        ...
        output_file_path = os.path.join(folder, f"{folder}_Sold_Data_Unique.xlsx")
